...
import edu.pitt.dbmi.i2b2.ontologystore.utils.ZipFileUtils;
import java.io.File;
...
public class OntologyDisableService extends AbstractOntologyService {
    ...
    @Autowired
    public OntologyDisableService(HiveDBAccess hiveDBAccess, MetadataInstallService metadataInstallService, FileSysService fileSysService, OntologyFileService ontologyFileService, DataSource ontologydemodsDataSource, DataSource querytooldemodsDataSource) {
